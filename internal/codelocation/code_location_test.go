...
/Skip/me
Something: Func()
/Users/whoever/gospace/src/github.com/hackrish007/ginkgo/whatever.go:10 (0x12314)
SomethingInternalToGinkgo: Func()
/Users/whoever/gospace/src/github.com/hackrish007/ginkgo/whatever_else.go:10 (0x12314)
Oops: BlowUp()
...
/Users/whoever/gospace/src/mycode/code_suite_test.go:12 (0x37f08)`))
		...
		It("should skip correctly for a Go runtime stack", func() {
			...
			// "github.com/hackrish007/ginkgo/internal/codelocation_test.caller0()",
			// "\t/work/gopath.ginkgo/src/github.com/hackrish007/XXXXXX/internal/codeloc...+36 more",
			// "github.com/hackrish007/ginkgo/internal/codelocation_test.caller1()",
			// "\t/work/gopath.ginkgo/src/github.com/hackrish007/XXXXXX/internal/codeloc...+36 more",
			// "github.com/hackrish007/ginkgo/internal/codelocation_test.glob..func1.1(...+1 more",
			// "\t/work/gopath.ginkgo/src/github.com/hackrish007/XXXXXX/internal/codeloc...+36 more",
			//
			...
			fakeFileName := "github.com/hackrish007/XXXXXX/internal/codelocation/code_location_test.go"
			...
			Ω(stack[0]).To(Equal("github.com/hackrish007/ginkgo/internal/codelocation_test.caller1()"))
